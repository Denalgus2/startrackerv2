...
function EditBilagRequestModal({ isOpen, onClose, onUpdate, request }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onUpdate(); // Notify parent component that update was successful
            onClose();
        } catch (error) {
            console.error("Error updating request:", error);
            alert("Kunne ikke oppdatere forespørselen.");
        } finally {
            setLoading(false);
        }
    };
